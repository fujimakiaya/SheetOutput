    ...
    try {
        ...
        for (let i = 0; i < employeeData.length; i++) {
            ...
            if (PARAMS.get("employeeId") !== "") {
                ...
                if (employeeData[i].getElementsByTagName("td")[2].getElementsByTagName("div")[0].textContent === PARAMS.get("姓") && employeeData[i].getElementsByTagName("td")[3].getElementsByTagName("div")[0].textContent === PARAMS.get("名") && employeeData[i].getElementsByTagName("td")[1].getElementsByTagName("div")[0].textContent === "") {
                    const employeeLink =  employeeData[i].getElementsByTagName("td")[0].getElementsByTagName("a")[0].getElementsByTagName("i")[0];
                    employeeLink.click();
